...
compute_face_normal(Face f) const
{
    ...
    else // face is a general polygon
    {
        ...
        do
        {
            // NOTE(stefalie): The original polygon normal computation seems
            // somewhat unstable (I had the problem once that a polygon normal
            // pointed the opposite direction). Using the Newell method below
